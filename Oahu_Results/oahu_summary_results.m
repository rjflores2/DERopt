...
dt0 = load("Oahu_diesel.mat");
dt1 = load("Oahu_5000.mat");
dt2 = load("Oahu_3000.mat");
dt3 = load("Oahu_1000.mat");
dt4 = load("Oahu_5000_nooil.mat");
dt5 = load("Oahu_3000_nooil.mat");
dt6 = load("Oahu_1000_nooil.mat");
...
co2_emissions = [ sum(dt0.var_legacy_diesel.electricity)
    sum(dt1.var_legacy_diesel.electricity)
    sum(dt2.var_legacy_diesel.electricity)
    sum(dt3.var_legacy_diesel.electricity)
    sum(dt4.var_legacy_diesel.electricity)
    sum(dt5.var_legacy_diesel.electricity)
    sum(dt6.var_legacy_diesel.electricity)].*co2_factor; %kg

co2_emissions_intensity = co2_emissions./sum(dt0.elec) %kg/kWh

adoped_tech = [dt1.var_wave.power dt1.var_pv.pv_adopt dt1.var_ees.ees_adopt dt1.var_pem.cap dt1.var_el.el_adopt dt1.var_h2es.h2es_adopt
    dt2.var_wave.power dt2.var_pv.pv_adopt dt2.var_ees.ees_adopt dt2.var_pem.cap dt2.var_el.el_adopt dt2.var_h2es.h2es_adopt
    dt3.var_wave.power dt3.var_pv.pv_adopt dt3.var_ees.ees_adopt dt3.var_pem.cap dt3.var_el.el_adopt dt3.var_h2es.h2es_adopt
    dt4.var_wave.power dt4.var_pv.pv_adopt dt4.var_ees.ees_adopt dt4.var_pem.cap dt4.var_el.el_adopt dt4.var_h2es.h2es_adopt
    dt5.var_wave.power dt5.var_pv.pv_adopt dt5.var_ees.ees_adopt dt5.var_pem.cap dt5.var_el.el_adopt dt5.var_h2es.h2es_adopt
    dt6.var_wave.power dt6.var_pv.pv_adopt dt6.var_ees.ees_adopt dt6.var_pem.cap dt6.var_el.el_adopt dt6.var_h2es.h2es_adopt]
...
close all
plot_data = [];
total_data = [sum(dt1.var_wave.electricity,2) ...
    sum(dt1.var_pv.pv_elec,2)...
    dt1.var_legacy_diesel.electricity...
    dt1.var_pem.elec ...
...
total_data = [sum(dt2.var_wave.electricity,2) ...
    sum(dt2.var_pv.pv_elec,2)...
    dt2.var_legacy_diesel.electricity...
    dt2.var_pem.elec ...
...
total_data = [sum(dt3.var_wave.electricity,2) ...
    sum(dt3.var_pv.pv_elec,2)...
    dt3.var_legacy_diesel.electricity...
    dt3.var_pem.elec ...
...
plot_data = [];
plot_data = [sum(dt1.var_wave.electricity,2) ...
    sum(dt1.var_pv.pv_elec,2)...
    dt1.var_legacy_diesel.electricity...
    dt1.var_pem.elec ...
    sum(dt1.var_ees.ees_dchrg + dt1.var_lees.ees_dchrg,2)
...
xlim([dt4.time((x_days-1)*24+1)  dt4.time((x_days+27)*24)])
if dt1.ldiesel_on
legend(a1([1:3 5]),'Wave','Solar PV','Oill','Battery Discharge','Orientation','horizontal','Location','south')
else
legend(a1([1:2 4:5]),'Wave','Solar PV','Oil','PEMFC','Battery Discharge','Orientation','horizontal','Location','south')
end
datetick('x','ddd','keeplimits','keepticks')
title('Wave: $5000/kW','FontSize',16)
ylabel({'Generation (kW)'},'FontSize',16)
% ylim([0 100])
hold off


plot_data = [sum(dt3.var_wave.electricity,2) ...
    sum(dt3.var_pv.pv_elec,2)...
    dt3.var_legacy_diesel.electricity...
    dt3.var_pem.elec ...
    sum(dt3.var_ees.ees_dchrg + dt3.var_lees.ees_dchrg,2)
...
legend(a2([1:3 5]),'Wave','Solar PV','Diesel','Battery Discharge','Orientation','horizontal','Location','south','NumColumns',2)
else
legend(a2([1:2 4:5]),'Wave','Solar PV','Oil','PEMFC','Battery Discharge','Orientation','horizontal','Location','south')
end
datetick('x','ddd','keeplimits','keepticks')
title('Wave: $1000/kW','FontSize',16)
ylabel({'Generation (kW)'},'FontSize',16)
% ylim([0 100])
hold off
...
set(gcf,'Position',[10 10 1075 500])
...
plot_data = [sum(dt2.var_wave.electricity,2) ...
    sum(dt2.var_pv.pv_elec,2)...
    dt2.var_legacy_diesel.electricity...
    dt2.var_pem.elec ...
    sum(dt2.var_ees.ees_dchrg + dt2.var_lees.ees_dchrg,2)
...
total_gen = [];
plot_data1 = [];
total_data = [sum(dt4.var_wave.electricity,2) ...
    sum(dt4.var_pv.pv_elec,2)...
    dt4.var_legacy_diesel.electricity...
    dt4.var_pem.elec ...
...
total_data = [sum(dt5.var_wave.electricity,2) ...
    sum(dt5.var_pv.pv_elec,2)...
    dt5.var_legacy_diesel.electricity...
    dt5.var_pem.elec ...
...
total_data = [sum(dt6.var_wave.electricity,2) ...
    sum(dt6.var_pv.pv_elec,2)...
    dt6.var_legacy_diesel.electricity...
    dt6.var_pem.elec ...
...
total_data = [dt4.elec ...
    ...
    sum(dt4.el_eff.*dt4.var_el.el_prod,2)    ]./1000;
for ii = 1:length(dt4.endpts)
...
total_data = [dt6.elec ...
    ...
    sum(dt6.el_eff.*dt6.var_el.el_prod,2)    ]./1000;
for ii = 1:length(dt4.endpts)
...
l1 = legend('$5000/kW','$1000/kW','Location','North')

l1.Title.String = 'Wave Cost'
