...
if crit_load_lvl>0 && ~isempty(opt_resiliency_model) &&  opt_resiliency_model == 2
    %% # of time steps
    ...
    Constraints = [Constraints
        (var_resiliency.pv_elec + var_resiliency.ees_dchrg + var_resiliency.dg_elec + var_resiliency.import == ...
