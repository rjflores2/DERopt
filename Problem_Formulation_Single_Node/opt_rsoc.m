...
if ~isempty(rsoc_v)
    Constraints = [Constraints
        ...
        (-var_rsoc.rsoc_adopt.*rsoc_v(7) <= var_rsoc.rsoc_elec(2:size(var_rsoc.rsoc_elec,1)) - ...
            var_rsoc.rsoc_elec(1:size(var_rsoc.rsoc_elec,1) - 1) <= var_rsoc.rsoc_adopt*rsoc_v(7)):...
