...
Constraints = [Constraints 
    ...
    (var_rsoc.rsoc_electrolyzer<= max(elec)*(1-var_rsoc.rsoc_e_onoff)): 'Electrolyzer Contraint'
...
%     (sum(var_rsoc.rsoc_fc_onoff(2:end) - var_rsoc.rsoc_fc_onoff(1:end-1), 2) <= max_switch):  'Switching condition'];
end 