    ...
    methods
        ...
        function Optimize(obj, UserInterfaceFig, PlotElectricSources, PlotElectricLoads)
            ...
            if bldgData.LoadData(append(obj.cfgManager.demo_data_path, '\Campus_Loads_2014_2019.mat'), obj.cfgManager.chiller_plant_opt)
                ...
                techSelOnSite.CalculateAllParams(obj.cfgManager.pv_on, obj.cfgManager.ees_on, obj.cfgManager.el_on, obj.cfgManager.h2es_on, obj.cfgManager.rel_on, obj.cfgManager.hrs_on, obj.cfgManager.h2_inject_on);
                ...
                capCostMods.DebtPaymentsFullCostSystem(techSelOnSite.pv_v, techSelOnSite.ees_v, techSelOnSite.el_v, ...
                                                        ...
                                                        obj.cfgManager.util_el_on, techSelOffSite.util_h2_inject_v, obj.cfgManager.rees_on)
                ...
                modelConstraints.Calculate_EES(modelVars, techSelOnSite.ees_v, techSelOnSite.pv_v, obj.cfgManager.rees_on);
                ...
                progBar.Value = (24/prepSteps);
                progBar.Message = "Model Constraints -> Utility Scale Solar Constraints";
    
                modelConstraints.Calculate_UtilitySolar(modelVars, techSelOffSite.utilpv_v, bldgData.e_adjust);
    
                progBar.Value = (25/prepSteps);
                progBar.Message = "Model Constraints -> Utility Scale Wind Constraints";
    
                modelConstraints.Calculate_UtilityWind(modelVars, techSelOffSite.util_wind_v, bldgData.e_adjust);
    
                progBar.Value = (26/prepSteps);
                progBar.Message = "Model Constraints -> Utility Scale Battery Storage Constraints";
    
                modelConstraints.Calculate_UtilityEESStorage(modelVars, techSelOffSite.util_ees_v);
    
                progBar.Value = (27/prepSteps);
                progBar.Message = "Model Constraints -> Utility Scale Electrolyzer Constraints";
    
                modelConstraints.Calculate_UtilityElectrolyzer(modelVars, techSelOffSite.util_el_v);
        ...
        function UpdatePlots(obj, ii, PlotElectricSources, PlotElectricLoads)
            ...
            if ii > 0 && ii <= length(obj.plotData_text)
                ...
                if ~isempty(PlotElectricSources)
                    ...
                    legend(PlotElectricSources,'Gas Turbine','Utility Import','Solar','Battery Discharge','Location','Best')
