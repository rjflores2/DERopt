classdef CLegacyTechnologies
    ...
    methods
        function obj = CLegacyTechnologies(lpv_on, ldg_on, lbot_on, lhr_on, ldb_on, lboil_on, lees_on, ltes_on, dg_legacy_cyc)
            ...
            if ldg_on
                ...
                q1 = 1.4027;
                q2 = -35.8337;
                obj.dg_legacy = [0.026; 9000; 5000; 0.01; 0.01; 0.52;f1; f2; q1; q2; 60*24*3];
            ...
            %     q2 = 0;
                ...
                obj.dg_legacy = [0.026; 14500; 13000; 0.01; 0.01; 0.52;f1; f2; q1; q2; 60*24*3];
                obj.dg_legacy = [0.026; 14500; 6000; 0.01; 0.01; 0.52;f1; f2; q1; q2; 60*24*3];
                obj.dg_legacy = [0.006; 14500; 6000; 0.01; 0.01; 0.52;f1; f2; q1; q2; 60*24*3];
            %     dg_legacy = [0.006; 14500; 0; 0.01; 0.01; 0.52;f1; f2; q1; q2; 60*24*3];
                ...
                if dg_legacy_cyc
                    obj.updatedDgLegacyCyc = [101*19; 0.74*15*(15-6)/((2*15000+6000)/4)];
                else
                    obj.updatedDgLegacyCyc = [];
                end
            end
            ...
            if lbot_on
                ...
                %%%Efficiency - 4
                %%%Heat utilization - 5
                obj.bot_legacy = [0.01; 4500; .1; 0.9; 0.3];
            ...
            obj.vc_legacy = [vc_v1 vc_v2 vc_v3 vc_v4 vc_v5 vc_v6 vc_v7];
            ...
            if lees_on
                ...
                obj.ees_legacy = [1000; 0.001; 0.001; 0.1; 0.95; 0.25; 0.25; .90; .90; .995];
            end
