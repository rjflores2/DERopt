...
if erwh_on
    erwh_v = [0    %%% 1000  1: Capital cost ($/kWel) https://www.homedepot.com/
               2.46];   %CZ16:ERWH:0.95 PremiumERWH:1 WHP:1.65  %%% 0.9 for ERWH 0.99 for premium on-demand, 2.46 for COP_HPWH 2: ERWH energy factor- COPHPWH = 3 from AHRI Directory  From RFJ model for premium heat pump COP is 2.46   
else 
    erwh_v = [];
end      
