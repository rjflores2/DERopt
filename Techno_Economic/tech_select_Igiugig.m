...
if pv_on
    ...
    pv_v1=[0.7*(1407953/1000); 0.2 ; 0.001];    
    
    pv_v2=[0.7*(2300+216); 0.2 ; 0.001];
    pv_v2=[0.7*(1000+216); 0.2 ; 0.001];
    pv_v2=[0.7*(1193481/1000); 0.2 ; 0.001];
...
if exist('pemfc_on') && pemfc_on
    ...
    pem_v = [613000/1000 0.45 0.005 0];
...
if ees_on
    ...
    ees_v=[0.7.*362829/1000; 0.001; 0.001; 0.1; 0.95; 0.25; 0.25; .90; .90; .995];
